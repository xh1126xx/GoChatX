...
func (c *authServiceClient) Validate(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) Validate(context.Context, *TokenRequest) (*TokenResponse, error) {
